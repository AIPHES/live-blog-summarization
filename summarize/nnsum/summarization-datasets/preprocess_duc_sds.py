...
def main():
    ...
    parser.add_argument(
        "--liveblogs", type=pathlib.Path, required=True,
        help="Path to LiveBlogs_corpus.tgz")
    parser.add_argument(
    ...
    liveblogs_dir  = args.data_dir / "liveblogs"
    liveblogs_di.mkdir(exist_ok=True, parents=True)
    ...
    make_train_valid_data(liveblogs_dir, data_dir, args.procs)
